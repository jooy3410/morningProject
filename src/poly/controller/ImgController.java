...
public class ImgController {
	...
	@ResponseBody
	public List<ImgDTO> getScrollImg(HttpServletRequest requset, HttpSession session) throws Exception{
		log.info("getScrollImg start!");
		...
		/*
		 * @ResponseBody가 있으면 html바디안에 json로 출력되고 object안에 들어갈수있다, 그다음 데이터를 
		 * 에이작스로 요청을하면 오브젝트로 포장할수있다.
		 */
		/*return rList;
    ...
    public String updateImg(HttpSession session, HttpServletRequest request, 
...
throws Exception {
		...
		if (ext.equals("jpeg") || ext.equals("jpg") || ext.equals("gif") || ext.equals("png")) {
				        ...
				        log.info("rDTO.getSaveFOlDER : " + pDTO.getSave_folder_name());
						log.info("rDTO.getfull_file_info : " + pDTO.getFull_file_info());
						log.info("rDTO.getsave_file_name : " + pDTO.getSave_file_name());
						log.info("rDTO.getorg_file_name : " + pDTO.getOrg_file_name());
	...
	public String imgDelete(HttpServletRequest request, HttpServletResponse response,
